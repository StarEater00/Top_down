...
public class Movement : MonoBehaviour
{
    ...
    void animate()
    {
        ...
        if (current_animation != "attack_running_left" && current_animation != "attack")
        {
        ...
        {   
            if (current_animation == "left_idle")
            {
                animate.CrossFade("attack",0f,0);
            }
 
            if (current_animation == "left")   
            {
                
                animate.CrossFade("attack_running_left",0f,0);
                //print(current_animation);
            }
        }
        
        if(Input.GetKeyUp("space") && current_animation == "attack")
        {
            animate.CrossFade("left_idle",0f,0);
        }
        if(Input.GetKeyUp("space") && current_animation == "attack_running_left")
            {
                animate.CrossFade("left",0f,0);
            }
